...
function calc() {
    ...
    if (age > 0 && height2 > 0 && weight2 > 0) {
        if (weight2 < 55) {
            ...
            $('.calc-form .line1').html('<span class="green">Avete un peso nella norma</span>');
            $('.calc-form .line2').html('Ma se siete predisposti all`ingrassamento fate attenzione!');
        } else {
            if (weight2 >= 55 && weight2 < 70) {
                $('.calc-form .line1').attr('style', 'visibility: display;');
                $('.calc-form .line2').attr('style', 'visibility: display;');
                $('.calc-form .line1').html('Obesità<br>1 stadio');
                $('.calc-form .line2').html('Iniziate subito la cura! ');
            } else {
                if (weight2 >= 70 && weight2 < 80) {
                    $('.calc-form .line1').attr('style', 'visibility: display;');
                    $('.calc-form .line2').attr('style', 'visibility: display;');
                    $('.calc-form .line1').html('Obesità <br>2 stadio');
                    $('.calc-form .line2').html('Iniziate subito la cura! ');
                } else {
                if (weight2 >= 80 ) {
                    $('.calc-form .line1').attr('style', 'visibility: display;');
                    $('.calc-form .line2').attr('style', 'visibility: display;');
                    $('.calc-form .line1').html('Obesità <br>3 stadio');
                    $('.calc-form .line2').html('Iniziate subito la cura! ');
                }
            }
            }
